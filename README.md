...
---
> **About**: A Minecraft Spigot extension plugin powered by **JNI (Java Native Interface)** that allows developers to load and run native modules — including C++, Rust, or Go — directly as server plugins.(emmm yeah~ We'll support more programming languages later...maybe?)
---
